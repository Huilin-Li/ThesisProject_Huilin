...
class PSO_UNIOA_asyncE_syncG(NatureOpt):
    ...
    def __call__(self):
        ...
        while not self.stop:
            ...
            # Ooptimize x(t+1) and evaluation
            temp_X, temp_X_Fit = self.Opt_X.pso_but_asyncE(func=self.fitness_function, old_X=X, old_X_Fit=X_Fit, new_Y=new_Y, lb_x=self.lb_x, ub_x=self.ub_x)
            # Selection
