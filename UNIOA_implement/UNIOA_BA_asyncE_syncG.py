...
class BA_UNIOA_asyncE_syncG(NatureOpt):
    ...
    def __call__(self):
        ...
        while not self.stop:
            ...
            # Oopt temp_x(t+1) and Evaluate
            temp_X, temp_X_Fit = self.Opt_X.ba_but_asyncE(func=self.fitness_function, old_X=X, old_X_Fit=X_Fit, new_Y=new_Y, old_x_g=x_g, old_z1=z1, old_z2=z2, w3=self.w3, lb_x=self.lb_x, ub_x=self.ub_x )
            # Selection
