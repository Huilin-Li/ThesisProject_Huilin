...
class CSA_UNIOA_asyncE(NatureOpt):
    ...
    def __call__(self):
        ...
        while not self.stop:
            ...
            temp_X,temp_X_Fit = self.Opt_X.csa_but_asyncE(func=self.fitness_function, old_X=X, old_X_Fit=X_Fit, X_p=X_p, w1=self.w1, w2=self.w2, lb_x=self.lb_x, ub_x=self.ub_x)
            # Selection
