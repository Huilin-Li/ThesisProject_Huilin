...
class MBO_SEP_asyncE_syncG(NatureOpt):
    ...
    @staticmethod
    #@njit(parallel=True)
    def migration_opt(func, numButterfly1, numButterfly2, population1, population2, n, period, partition):
        ...
        return NewPopulation1, NewPopulation1_f

    @staticmethod
    #@jit(parallel=True)
    def adjusting_opt(func, genIndex, sorted_pop, numButterfly2, population2, maxStepSize,n, partition,budget, BAR,lb_x, ub_x):
        t = genIndex + 1
    ...
    def __call__(self):
        ...
        while not self.stop:
            ...
            # migration
            NewPopulation1, NewPopulation1_f = self.migration_opt(func=self.fitness_function, numButterfly1=numButterfly1, numButterfly2=numButterfly2,
            ...
            # adjusting
            NewPopulation2, NewPopulation2_f = self.adjusting_opt(func=self.fitness_function, genIndex=genIndex, sorted_pop=sorted_pop, numButterfly2=numButterfly2,
