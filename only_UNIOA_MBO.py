...
if __name__ == '__main__':
    ...
    subprocess.call(['screen -dmS MBO021 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 1'],shell=True)
    subprocess.call(['screen -dmS MBO022 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 2'],shell=True)
    subprocess.call(['screen -dmS MBO023 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 3'],shell=True)
    subprocess.call(['screen -dmS MBO024 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 4'],shell=True)
    subprocess.call(['screen -dmS MBO025 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 5'],shell=True)
    subprocess.call(['screen -dmS MBO026 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 6'],shell=True)
    subprocess.call(['screen -dmS MBO027 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 7'],shell=True)
    subprocess.call(['screen -dmS MBO028 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 8'],shell=True)
    subprocess.call(['screen -dmS MBO029 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 9'],shell=True)
    subprocess.call(['screen -dmS MBO0210 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 10'],shell=True)
    subprocess.call(['screen -dmS MBO0211 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 11'],shell=True)
    subprocess.call(['screen -dmS MBO0212 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 12'],shell=True)
    subprocess.call(['screen -dmS MBO021 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 13'], shell=True)
    subprocess.call(['screen -dmS MBO022 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 14'], shell=True)
    subprocess.call(['screen -dmS MBO023 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 15'], shell=True)
    subprocess.call(['screen -dmS MBO024 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 16'], shell=True)
    subprocess.call(['screen -dmS MBO025 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 17'], shell=True)
    subprocess.call(['screen -dmS MBO026 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 18'], shell=True)
    subprocess.call(['screen -dmS MBO027 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 19'], shell=True)
    subprocess.call(['screen -dmS MBO028 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 20'], shell=True)
    subprocess.call(['screen -dmS MBO029 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 21'], shell=True)
    subprocess.call(['screen -dmS MBO0210 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 22'], shell=True)
    subprocess.call(['screen -dmS MBO0211 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 23'], shell=True)
    subprocess.call(['screen -dmS MBO0212 python ./run.py -n MBO_UNIOA -o UNIOA_BA -p 24'], shell=True)
    # </editor-folder>
